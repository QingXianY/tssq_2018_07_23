...
class SmsMultiSender {
    ...
    public function __construct($appid, $appkey) {
        $this->url = "https://sms.banling.com/intf/sendmultisms";
        $this->appid =  $appid;
        $this->appkey = $appkey;
    }
     ...
     */
    public function send($type, $nationCode, $phoneNumbers, $msg, $ext = "") {
/*
请求包体
{
    "tel": [
...
*/
     ...
     * @return string json string { "result": xxxxx, "errmsg": "xxxxxx" ... }，被省略的内容参见协议文档
     */
    public function sendWithParam($nationCode, $phoneNumbers, $templId, $params, $sign = "", $ext = "") {
/*
请求包体
{
    "tel": [
