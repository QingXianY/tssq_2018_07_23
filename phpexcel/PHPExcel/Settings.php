...
class PHPExcel_Settings
{
    ...
    /**
     * Name of the config used for Zip file management
     *    e.g.
     *        ZipArchive
     *
     * @var string
     ...
     *
     * @param string $zipClass    The Zip handler config that PHPExcel should use for Zip file management
    ...
    /**
     * Return the name of the config that is currently being used for cell cacheing
     *
     * @return string Name of the config currently being used for cacheing
     */
