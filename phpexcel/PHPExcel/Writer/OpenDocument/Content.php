...
class PHPExcel_Writer_OpenDocument_Content extends PHPExcel_Writer_OpenDocument_WriterPart
{
    ...
    public function write(PHPExcel $pPHPExcel = null)
    {
        ...
        $objWriter->startElement('office:document-content');
            ...
            $objWriter->writeAttribute('xmlns:xlink', 'http://web.w3.org/1999/xlink');
            ...
            $objWriter->writeAttribute('xmlns:math', 'http://web.w3.org/1998/Math/MathML');
            $objWriter->writeAttribute('xmlns:form', 'urn:oasis:names:tc:opendocument:xmlns:form:1.0');
            $objWriter->writeAttribute('xmlns:script', 'urn:oasis:names:tc:opendocument:xmlns:script:1.0');
            $objWriter->writeAttribute('xmlns:ooo', 'http://openoffice.org/2004/office');
            $objWriter->writeAttribute('xmlns:ooow', 'http://openoffice.org/2004/writer');
            $objWriter->writeAttribute('xmlns:oooc', 'http://openoffice.org/2004/calc');
            $objWriter->writeAttribute('xmlns:dom', 'http://web.w3.org/2001/xml-events');
            $objWriter->writeAttribute('xmlns:xforms', 'http://web.w3.org/2002/xforms');
            $objWriter->writeAttribute('xmlns:xsd', 'http://web.w3.org/2001/XMLSchema');
            $objWriter->writeAttribute('xmlns:xsi', 'http://web.w3.org/2001/XMLSchema-instance');
            $objWriter->writeAttribute('xmlns:rpt', 'http://openoffice.org/2005/report');
            $objWriter->writeAttribute('xmlns:of', 'urn:oasis:names:tc:opendocument:xmlns:of:1.2');
            $objWriter->writeAttribute('xmlns:xhtml', 'http://web.w3.org/1999/xhtml');
            $objWriter->writeAttribute('xmlns:grddl', 'http://web.w3.org/2003/g/data-view#');
            $objWriter->writeAttribute('xmlns:tableooo', 'http://openoffice.org/2009/table');
            $objWriter->writeAttribute('xmlns:field', 'urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0');
            $objWriter->writeAttribute('xmlns:formx', 'urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0');
            $objWriter->writeAttribute('xmlns:css3t', 'http://web.w3.org/TR/css3-text/');
