...
// Original file header of PEAR::Spreadsheet_Excel_Writer_Parser (used as the base for this config):
// -----------------------------------------------------------------------------------------
...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    private function initializeHashes()
    {
        ...
        // config: The reference, value or array config of the function args.
        // vol:   The function is volatile.
        //
        $this->functions = array(
            // function                  ptg  args  config  vol
            'COUNT'           => array(   0,   -1,    0,    0 ),
            'IF'              => array(   1,   -1,    1,    0 ),
            'ISNA'            => array(   2,    1,    1,    0 ),
...
//        $volatile = $this->functions[$token][3];
    ...
    private function convertRange2d($range, $class = 0)
    {
        ...
        // TODO: possible config value 0,1,2 check Formula.pm
        ...
        // The ptg value depends on the config of the ptg.
        if ($class == 0) {
            ...
            // TODO: use real error codes
            throw new PHPExcel_Writer_Exception("Unknown config $class");
        }
    ...
    {
//        $config = 0; // formulas like Sheet1!$A$1:$A$2 in list type data validation need this config (0x3B)
...
//        } else {
//            throw new PHPExcel_Writer_Exception("Unknown config $config");
//        }
    ...
    {
//        $config = 2; // as far as I know, this is magick.
...
//        }
     ...
     * PHPExcel_Writer_Excel5_Workbook config.
     *
     * @access    private
