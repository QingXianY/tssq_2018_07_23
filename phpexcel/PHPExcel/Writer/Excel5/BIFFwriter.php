...
// Original file header of PEAR::Spreadsheet_Excel_Writer_BIFFwriter (used as the base for this config):
// -----------------------------------------------------------------------------------------
...
// *  config library should be directed to me.
// *
// *  License Information:
// *
...
//        $this->limit      = 8224;
    ...
    /**
     * Determine the byte order and store it as config data to avoid
