...
class PHPExcel_Writer_PDF implements PHPExcel_Writer_IWriter
{
    ...
    /**
     *  Instantiate a new renderer of the configured type within this container config
     *
    ...
    /**
     *  Magic method to handle direct calls to the configured PDF renderer wrapper config.
     *
