...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            //    Retrieve OVERWRITE and CREATE constants from the instantiated zip config
            //    This method of accessing constant values from a dynamic config should work with all appropriate versions of PHP
