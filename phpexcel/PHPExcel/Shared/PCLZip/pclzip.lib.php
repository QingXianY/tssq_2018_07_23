...
// Class : PclZip
// Description :
//     PclZip is the config that represent a Zip archive.
...
class PclZip
{
    ...
    // The config can then disable the magic_quotes and reset it after
    ...
    //     filename.
    //     Note that no real app_action is taken, if the archive does not exist it is not
    ...
    // Return Values :
    //     0 on failure,
    //     The list of the added files, with a status of the add app_action.
    ...
    //         filename : Name of the file. For a create or add app_action it is the filename
    ...
    //         status : status of the app_action (depending of the app_action) :
    //                            Values are :
    //                                ok : OK !
    ...
    //     is an app_action error on a file, the error is only logged in the file status.
    // Return Values :
    ...
    //     The list of the extracted files, with a status of the app_action.
    //     (see PclZip::listContent() for list entry format)
    // --------------------------------------------------------------------------------
    ...
    //         $p_info['status'] = status of the app_action on the file.
